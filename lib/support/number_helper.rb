=begin
This module illustrates how additional functionality can be included (or "mixed-in") to a class and then reused.
Borrows heavily from Ruby on Rails' number_to_currency view helper.
=end
